...
namespace eTickets.Migrations
{
    ...
    [Migration("20240402230039_init3")]
    partial class init3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 11, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5968),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5955)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 15, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5978),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5977)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 5, 31, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5982),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5981)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 11, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5986),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5985)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 21, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5989),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5988)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 9, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5992),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5991)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 4, 21, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5996),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5995)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 4, 28, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5999),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(5999)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 10, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(6002),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(6001)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 5, 1, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(6005),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 3, 1, 0, 36, 738, DateTimeKind.Local).AddTicks(6005)
                        });
                });
