...
namespace eTickets.Migrations
{
    ...
    [Migration("20240405163953_init12")]
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 13, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8521),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8508)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 17, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8533),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8532)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 6, 2, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8537),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8536)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 13, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8540),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8539)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 23, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8543),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8543)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 11, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8546),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8546)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 4, 23, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8549),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8549)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 4, 30, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8552),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8552)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 12, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8555),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8555)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 5, 3, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8558),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 5, 18, 39, 50, 196, DateTimeKind.Local).AddTicks(8558)
                        });
                });
