...
namespace eTickets.Migrations
{
    ...
    [Migration("20240402195947_init2")]
    partial class init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 10, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7615),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7603)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 14, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7625),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7624)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 5, 30, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7628),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7628)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 10, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7631),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7631)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 20, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7634),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7634)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 8, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7637),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7637)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 4, 20, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7640),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7640)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 4, 27, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7644),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7643)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 9, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7647),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7646)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 4, 30, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7650),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 2, 21, 59, 36, 911, DateTimeKind.Local).AddTicks(7649)
                        });
                });
