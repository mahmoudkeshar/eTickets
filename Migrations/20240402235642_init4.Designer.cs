...
namespace eTickets.Migrations
{
    ...
    [Migration("20240402235642_init4")]
    partial class init4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 11, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8596),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8584)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 15, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8609),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8608)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 5, 31, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8612),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8611)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 11, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8615),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8614)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 21, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8618),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8617)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 9, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8621),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8620)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 4, 21, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8624),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8623)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 4, 28, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8626),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8626)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 10, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8629),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8629)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 5, 1, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8632),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 3, 1, 56, 35, 883, DateTimeKind.Local).AddTicks(8632)
                        });
                });
