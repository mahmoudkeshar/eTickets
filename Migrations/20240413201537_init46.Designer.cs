...
namespace eTickets.Migrations
{
    ...
    [Migration("20240413201537_init46")]
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 21, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(667),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(656)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 25, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(680),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(679)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 6, 10, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(684),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(683)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 21, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(687),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(686)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 31, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(690),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(689)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 19, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(693),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(692)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 5, 1, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(696),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(696)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 5, 8, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(699),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(698)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 20, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(702),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(701)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 5, 11, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(705),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 13, 22, 15, 34, 885, DateTimeKind.Local).AddTicks(705)
                        });
                });
