...
namespace eTickets.Migrations
{
    ...
    [Migration("20240405015023_init8")]
    partial class init8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eTickets.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 13, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8847),
                            ImageURL = "Mad Max.jfif",
                            MovieCategory = 1,
                            Name = "Mad Max",
                            Price = 10.0,
                            ProducerId = 1,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8819)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            EndDate = new DateTime(2024, 4, 17, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8861),
                            ImageURL = "Superbad.jfif",
                            MovieCategory = 2,
                            Name = "Superbad",
                            Price = 20.0,
                            ProducerId = 2,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8860)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            EndDate = new DateTime(2024, 6, 2, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8866),
                            ImageURL = "The Shawshank Redemption.jfif",
                            MovieCategory = 3,
                            Name = "The Shawshank Redemption",
                            Price = 30.0,
                            ProducerId = 3,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8865)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            EndDate = new DateTime(2024, 5, 13, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8870),
                            ImageURL = "March of the Penguins.jfif",
                            MovieCategory = 4,
                            Name = "March of the Penguins",
                            Price = 20.0,
                            ProducerId = 4,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8869)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            EndDate = new DateTime(2024, 5, 23, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8875),
                            ImageURL = "Toy Story.jfif",
                            MovieCategory = 5,
                            Name = "Toy Story",
                            Price = 20.0,
                            ProducerId = 5,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8874)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            EndDate = new DateTime(2024, 5, 11, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8881),
                            ImageURL = "The Shining.jfif",
                            MovieCategory = 6,
                            Name = "The Shining",
                            Price = 20.0,
                            ProducerId = 6,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8880)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            EndDate = new DateTime(2024, 4, 23, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8885),
                            ImageURL = "The Dark Knight.jfif",
                            MovieCategory = 1,
                            Name = "The Dark Knight",
                            Price = 150.0,
                            ProducerId = 7,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8884)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            EndDate = new DateTime(2024, 4, 30, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8889),
                            ImageURL = "The Hangover.jfif",
                            MovieCategory = 2,
                            Name = "The Hangover",
                            Price = 90.0,
                            ProducerId = 8,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8888)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            EndDate = new DateTime(2024, 4, 12, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8894),
                            ImageURL = "Forrest Gump.jfif",
                            MovieCategory = 3,
                            Name = "Forrest Gump",
                            Price = 10.0,
                            ProducerId = 9,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8893)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            EndDate = new DateTime(2024, 5, 3, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8898),
                            ImageURL = "Won't_You_Be_My_Neighbor.jfif",
                            MovieCategory = 4,
                            Name = "Won't You Be My Neighbor?",
                            Price = 20.0,
                            ProducerId = 10,
                            StartDate = new DateTime(2024, 4, 5, 3, 50, 20, 771, DateTimeKind.Local).AddTicks(8897)
                        });
                });
